...
public class GetCourseListByCreditWorkIdRequestHandlerTests
{
    [Fact]
    public async Task Handle_ExistingRecords_ReturnsMappedCourses()
    {
        ...
        courseRepo.Setup(x => x.GetCoursesByCreditWorkIdAsync(It.IsAny<Guid>()))
        ...
        var handler = new GetCourseListByCreditWorkIdRequestHandler(uow.Object, userService.Object);
        var request = new GetCourseListByCreditWorkIdRequest { CreditWorkId = Guid.NewGuid() };
    ...
    public async Task Handle_NoRecords_ReturnsEmptyList()
    {
        ...
        var uow = UnitOfWorkMock.Create(courseRepo: courseRepo);
        var handler = new GetCourseListByCreditWorkIdRequestHandler(uow.Object, new Mock<IUserService>().Object);
        var request = new GetCourseListByCreditWorkIdRequest { CreditWorkId = Guid.NewGuid() };
